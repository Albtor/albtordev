...
<html lang="en">
  ...
  <body>
    ...
    <section class="site-hero overlay page-inside" style="background-image: url(img/password.jpeg)">
      <div class="container">
        <div class="row site-hero-inner align-items-center">
          <div class="col-md-7 text-left mr-auto">
            <h1 class="heading" data-aos="fade-up">Recupera tu Password</h1>
          </div>
        </div>
            ...
            <form action="#" method="post" class="bg-white p-md-5 p-4 mb-5" style="margin-top: -150px;">
              ...
              <div class="row">
                <div class="col-md-6 form-group">
                  <input type="submit" value="Recuperar password" class="btn btn-primary">
                </div>
              </div>
            </form>
