...
<html lang="en">
  ...
  <body>
    ...
    <section class="site-hero overlay page-inside" style="background-image: url(img/v-vet5.jpg)">
      <div class="container">
        ...
        <div class="row">
          <div class="col-md-7">
            ...
            <form action="mysqllog.php" method="POST" class="bg-white p-md-5 p-4 mb-5" style="margin-top: -150px;">
              ...
              <div class="row">
                <div class="col-md-6 form-group">
                  <a href="password.php" type="submit2" value="Olvidé mi password" class="btn btn-primary">Olvidé mi password</a>
                </div>
              </div>
              <div class="row">
                <div class="col-md-6 form-group">
                  <a href="Registro.php" type="submit3" value="No tengo cuenta" class="btn btn-primary">Registrarme</a>
                </div>
              </div>
