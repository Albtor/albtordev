...
<html lang="en">
  ...
  <body>
    ...
    <section class="site-hero overlay page-inside" style="background-image: url(img/v-veterinaria3.jpg)">
      <div class="container">
        <div class="row site-hero-inner align-items-center">
          <div class="col-md-7 text-left mr-auto">
            <h1 class="heading" data-aos="fade-up">Cita</h1>
          </div>
        </div>
      ...
      <div class="container">
        <div class="row">
          <div class="col-md-7">
            ...
            <form action="mysqlcita.php" method="POST" class="bg-white p-md-5 p-4 mb-5" style="margin-top: -150px;">
              <div class="row">
              ...
              <div class="row">
                <div class="col-md-12 form-group">
                  ...
                  <input type="text" id="mascota" class="form-control ">
                </div>
              </div>
              <div class="row">
                <div class="col-md-12 form-group">
                  <label for="tipo">Tipo mascota</label>
                  <input type="text" id="tipo" class="form-control ">
                </div>
              </div>
              <div class="row">
                <div class="col-md-12 form-group">
                  <label for="tipo">Tipo servicio (peluquería, doctor, guarderia)</label>
                  <input type="text" id="tipo" class="form-control ">
                </div>
              </div>
              <div class="row">
              ...
              <div class="row">
                <div class="col-md-12 form-group">
                  <label for="sintomas">Sintomatología y motivo de consulta</label>
                  <textarea name="message" id="sintomas" class="form-control " cols="30" rows="8"></textarea>
                </div>
              </div>
              <div class="row">
                <div class="col-md-6 form-group">
