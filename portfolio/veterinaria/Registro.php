...
<html lang="en">
  ...
  <body>
    ...
    <section class="site-hero overlay page-inside" style="background-image: url(img/vetmale2.jpg)">
      <div class="container">
        <div class="row site-hero-inner align-items-center">
          <div class="col-md-7 text-left mr-auto">
            <h1 class="heading" data-aos="fade-up">Registro</h1>
          </div>
        </div>
      ...
      <div class="container">
        <div class="row">
          <div class="col-md-7">
            ...
            <form action="mysqlreg.php" method="POST" class="bg-white p-md-5 p-4 mb-5" style="margin-top: -150px;">
              <div class="row">
          ...
          if (isset($_POST['submit'])){
            ...
            echo "Los passwords no coinciden, intentalo de nuevo";
        } 
        ?>
